...
import org.xtext.example.blorquescript.blorqueScript.Greeting;
import org.xtext.example.blorquescript.blorqueScript.Model;
...
public class BlorqueScriptSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == BlorqueScriptPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case BlorqueScriptPackage.GREETING:
				if(context == grammarAccess.getGreetingRule()) {
					sequence_Greeting(context, (Greeting) semanticObject); 
					return; 
				}
				else break;
			case BlorqueScriptPackage.MODEL:
	...
	protected void sequence_Greeting(EObject context, Greeting semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, BlorqueScriptPackage.Literals.GREETING__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BlorqueScriptPackage.Literals.GREETING__NAME));
		}
