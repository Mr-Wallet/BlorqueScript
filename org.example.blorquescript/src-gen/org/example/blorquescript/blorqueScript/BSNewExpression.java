 ...
 *   <li>{@link org.example.blorquescript.blorqueScript.BSNewExpression#getType <em>Type</em>}</li>
...
public interface BSNewExpression extends BSExpression
{
   ...
   * @see #setType(BSClass)
   * @see org.example.blorquescript.blorqueScript.BlorqueScriptPackage#getBSNewExpression_Type()
   * @model
   * @generated
   */
  BSClass getType();
  ...
  /**
   * Sets the value of the '{@link org.example.blorquescript.blorqueScript.BSNewExpression#getType <em>Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
